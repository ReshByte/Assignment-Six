...
const displayLesson=(lessons)=>{ 
    ...
    for(let lesson of lessons){
        ...
        btnDiv.innerHTML = `
        <p  id="lesson-btn-${lesson.category_name}" onclick="loadLevelWord('${lesson.id}')" class="w-[250px] mb-2 inter-font font-normal text-[16px] p-1 rounded-[4px] text-[#1F2937] hover:bg-[#15803D] hover:text-white"> ${lesson.category_name}</p>
        `
